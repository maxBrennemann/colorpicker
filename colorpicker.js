var Colorpicker = function(parent) {
    this.canvas = this.createHiDPICanvas(300, 200); // general Canvas
    ...
    this.initialize = function() {
        ...
        parent.appendChild(this.colorSpan);
    };
...
Colorpicker.prototype.createForegroundSelector = function() {
 ...
 */
Colorpicker.prototype.applyStyle = function(element) {
    element.style.borderRadius = "6px";
    element.style.display = "block";
    element.style.margin = "10px";
}

Colorpicker.prototype.drawForegroundSelectorGradient = function() {
...
Colorpicker.prototype.createSlider = function(parent) {
...
Colorpicker.prototype.applyEventListeners = function() {
...
Colorpicker.prototype.outputColor = function(canvas) {
    this.createForegroundColor();
    this.createBackgroundGradient();
...
Colorpicker.prototype.createCircles = function() {
    // white circle
...
Colorpicker.prototype.loadHTML = function () {
...
Colorpicker.prototype.getMousePos = function(canvas, evt) {
...
Colorpicker.prototype.createHiDPICanvas = function(w, h, ratio) {
